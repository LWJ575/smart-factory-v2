...
/* ============================================================
 * FreeRTOS 配置 — STM32F103ZET6 精英版 (v2.1, 无 LVGL)
 * 标准 SPL 版本, 不依赖 HAL
 * 无 LVGL: 堆从 30KB 降至 20KB
 * ============================================================ */
...
#define configTOTAL_HEAP_SIZE          ((size_t)(20 * 1024))  /* 20KB 堆 (无 LVGL) */
...
#define configUSE_TICK_HOOK              1      /* 用 tick hook (bsp 毫秒计数) */
